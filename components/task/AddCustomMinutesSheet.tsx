 ...
 * Wheel picker for custom minute selection (1-59)
...
interface AddCustomMinutesSheetProps {
  visible: boolean;
  onClose: () => void;
...
export const AddCustomMinutesSheet: React.FC<AddCustomMinutesSheetProps> = ({
  visible,
  onClose,
  onAddMinutes,
  initialValue = 30,
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.headerTitle}>Add Custom Minutes</Text>
...
export default AddCustomMinutesSheet;
