...
export const CircleIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
...
export const CircleCheckIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const DescriptionIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M4 6H20"
      stroke={color}
...
// Calendar icon
export const CalendarIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect
      x="3"
      y="4"
...
// Clock/Time icon
export const ClockIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle
      cx="12"
      cy="12"
...
// Tag/Category icon
export const TagIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// People/Users icon
export const PeopleIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Bell/Reminder icon
export const BellIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// Plus icon
export const PlusIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M12 5V19"
      stroke={color}
...
export const SunIcon: React.FC<IconProps> = ({ size = 24, color = '#F59E0B' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const SquareIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect
      x="3"
      y="3"
...
export const CouchIcon: React.FC<IconProps> = ({ size = 24, color = '#3B82F6' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const ArrowRightIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M5 12H19"
      stroke={color}
...
export const MinusCircleIcon: React.FC<IconProps> = ({ size = 24, color = '#6B7280' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const CalendarPlusIcon: React.FC<IconProps> = ({ size = 24, color = '#F97316' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect
      x="3"
      y="4"
...
export const MoreHorizontalIcon: React.FC<IconProps> = ({ size = 24, color = '#FFFFFF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// Check icon
export const CheckIcon: React.FC<IconProps> = ({ size = 24, color = '#9039FF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M20 6L9 17L4 12"
      stroke={color}
